...
const Schema: z.ZodType<Prisma.OfferProposalCreateNestedManyWithoutProposerInput> =
  z
    .object({
      create: z
        .union([
...
export const OfferProposalCreateNestedManyWithoutProposerInputObjectSchema =
  Schema;
