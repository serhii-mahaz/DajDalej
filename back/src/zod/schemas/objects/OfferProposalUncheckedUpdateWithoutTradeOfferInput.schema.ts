...
const Schema: z.ZodType<Prisma.OfferProposalUncheckedUpdateWithoutTradeOfferInput> =
  z
    .object({
      id: z
        .union([
...
export const OfferProposalUncheckedUpdateWithoutTradeOfferInputObjectSchema =
  Schema;
