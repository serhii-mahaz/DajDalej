...
const Schema: z.ZodType<Prisma.ProposalItemCreateNestedOneWithoutItemInput> = z
  .object({
    create: z
      .union([
    ...
    connectOrCreate: z
      ...
      .optional(),
    connect: z.lazy(() => ProposalItemWhereUniqueInputObjectSchema).optional(),
  })
  .strict();

export const ProposalItemCreateNestedOneWithoutItemInputObjectSchema = Schema;
