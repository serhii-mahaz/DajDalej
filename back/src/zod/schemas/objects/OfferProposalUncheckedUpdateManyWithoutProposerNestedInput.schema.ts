...
const Schema: z.ZodType<Prisma.OfferProposalUncheckedUpdateManyWithoutProposerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const OfferProposalUncheckedUpdateManyWithoutProposerNestedInputObjectSchema =
  Schema;
