...
const Schema: z.ZodType<Prisma.TradeOfferUncheckedCreateNestedManyWithoutOwnerInput> =
  z
    .object({
      create: z
        .union([
...
export const TradeOfferUncheckedCreateNestedManyWithoutOwnerInputObjectSchema =
  Schema;
