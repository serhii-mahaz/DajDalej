...
const Schema: z.ZodType<Prisma.ProposalItemUpdateManyWithoutOfferProposalNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProposalItemUpdateManyWithoutOfferProposalNestedInputObjectSchema =
  Schema;
