...
const Schema: z.ZodType<Prisma.ProposalItemUncheckedCreateNestedManyWithoutOfferProposalInput> =
  z
    .object({
      create: z
        .union([
...
export const ProposalItemUncheckedCreateNestedManyWithoutOfferProposalInputObjectSchema =
  Schema;
