...
const Schema: z.ZodType<Prisma.OfferProposalUpdateManyWithoutTradeOfferNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const OfferProposalUpdateManyWithoutTradeOfferNestedInputObjectSchema =
  Schema;
