...
const Schema: z.ZodType<Prisma.TradeOfferItemUpdateOneWithoutItemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TradeOfferItemUpdateOneWithoutItemNestedInputObjectSchema = Schema;
