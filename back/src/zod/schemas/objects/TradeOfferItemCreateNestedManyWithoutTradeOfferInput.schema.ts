...
const Schema: z.ZodType<Prisma.TradeOfferItemCreateNestedManyWithoutTradeOfferInput> =
  z
    .object({
      create: z
        .union([
...
export const TradeOfferItemCreateNestedManyWithoutTradeOfferInputObjectSchema =
  Schema;
