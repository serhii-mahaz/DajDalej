...
const Schema: z.ZodType<Prisma.ProposalItemUpdateOneWithoutItemNestedInput> = z
  .object({
    create: z
      .union([
...
export const ProposalItemUpdateOneWithoutItemNestedInputObjectSchema = Schema;
