...
const Schema: z.ZodType<Prisma.TradeOfferItemUncheckedUpdateManyWithoutTradeOfferNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TradeOfferItemUncheckedUpdateManyWithoutTradeOfferNestedInputObjectSchema =
  Schema;
