...
const Schema: z.ZodType<Prisma.TradeOfferItemCreateNestedOneWithoutItemInput> =
  z
    .object({
      create: z
        .union([
...
export const TradeOfferItemCreateNestedOneWithoutItemInputObjectSchema = Schema;
