...
const Schema: z.ZodType<Prisma.OfferProposalCreateNestedManyWithoutTradeOfferInput> =
  z
    .object({
      create: z
        .union([
...
export const OfferProposalCreateNestedManyWithoutTradeOfferInputObjectSchema =
  Schema;
