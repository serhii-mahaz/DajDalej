...
const Schema: z.ZodType<Prisma.TradeOfferUncheckedUpdateManyWithoutOwnerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TradeOfferUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema =
  Schema;
